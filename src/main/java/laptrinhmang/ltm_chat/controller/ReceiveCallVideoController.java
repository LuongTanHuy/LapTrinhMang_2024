...
public class ReceiveCallVideoController {
    @FXML
    private Circle C_Image;
    @FXML
    private Button BT_StopCall, BT_Disconnect, BT_HiddenCamera, BT_HiddenSound,BT_AcceptCall;
    @FXML
    private Pane P_Video,P_ConnectingToReceiver;
    ...
    public void initialize() {
        ...
        P_ConnectingToReceiver.setVisible(true);

        // Button Accept Call
        FontIcon icon6 = new FontIcon("fas-phone-alt");
        icon6.setIconSize(20);
        icon6.setIconColor(Color.WHITE);
        BT_AcceptCall.setGraphic(icon6);
    ...
    @FXML
    public void acceptCallVideo(ActionEvent event){
        P_Video.setVisible(true);
        P_ConnectingToReceiver.setVisible(false);
    }
